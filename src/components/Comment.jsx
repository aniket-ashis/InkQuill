    ...
    <div className="m-5">
      ...
      <div className="bg-slate-800 p-5 rounded-lg">
        ...
        <p>
          ...
          aperiam necessitatibus minus ut perferendis natus voluptatem
          assumenda, saepe a, quas aspernatur voluptas numquam sit quibusdam
          incidunt est consequuntur nihil.
        </p>
      </div>
    </div>
  );
